...
function Admin() {
  ...
  const uploadfile = async (file) => {
    ...
    var upload=s3.uploadFile(file, file.name)
                                  ...
                                  {sessionlist.map((x, i) => {
                                    return (
                                      <div style={{ boxShadow: "rgba(0, 0, 0, 0.15) 0px 5px 15px 0px" }} className="card bg-white rounded mt-4 ">
                                        <div className="card-body my-2">
                                          <h4>Session {i + 1}</h4>
                                          <input type="text" class="form-control mb-2" id="exampleInputEmail1" aria-describedby="emailHelp" value={x.videos} onChange={(e) => { onchangevideo(e, i) }} placeholder="Session Name" />
                                          <form>
